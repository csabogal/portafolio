                    ...
                    <div className="aspect-video rounded-xl overflow-hidden bg-dark-700">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          if (parent) {
                            parent.innerHTML = `
                              <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-violet-500/20 to-indigo-500/20">
                    ...
                    <div className="mb-6">
                      ...
                      <ul className="grid sm:grid-cols-2 gap-2">
                        {project.features.slice(0, 4).map((feature) => (
                          ...
                          >
                            <ChevronRight className="text-violet-400 mt-0.5 flex-shrink-0" size={16} />
                            {feature}
                          </li>
                        ))}
                      </ul>
